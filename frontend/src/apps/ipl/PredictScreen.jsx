...
import { getTeam } from './iplTeams.js';
  ...
  return (
    <div className="ball-predict-shell">
      ...
      <div className="ball-predict-inner">
        ...
        {/* Flavour */}
        <div className="ball-predict-footer ipl-predict-footer">
          30 sec match · physics-based · cricket edition
        </div>
      </div>
    </div>
  );
...
function TeamCard({ team, side }) {
  return (
    <div className={`ball-team-card ball-team-card--${side}`}>
      <div className="ball-team-flag-large">
        {team.imageSrc
          ? <img src={team.imageSrc} alt={team.name} style={{ width: 64, height: 64, objectFit: 'contain' }} />
          : team.flag}
      </div>
